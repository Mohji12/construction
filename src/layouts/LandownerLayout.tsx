...
const navItems = [
  ...
  { path: "/landowner/my-projects", label: "My Projects", icon: FolderOpen },
];
...
const projectItems = [
  ...
  { path: "/landowner/reconstruction", label: "Reconstruction / Repair", icon: Wrench },
];
...
const LandownerLayout = () => {
  ...
  const isActive = (path: string) => {
    return location.pathname === path || (path !== "/landowner/dashboard" && location.pathname.startsWith(path));
  };
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <aside className="w-72 shrink-0 bg-white border-r border-gray-200 hidden lg:flex flex-col">
        ...
        <div className="p-6 border-b border-gray-200">
          <Link to="/landowner/dashboard" className="flex items-center gap-3 group">
            ...
            <div>
              <div className="font-semibold text-black text-lg">Landowner</div>
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-white">
        ...
        <header className="lg:hidden border-b border-gray-200 bg-white px-4 py-3 flex items-center justify-between sticky top-0 z-50">
          <Link to="/landowner/dashboard" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-green-600 flex items-center justify-center">
              <User className="w-4 h-4 text-white" />
            </div>
            <span className="font-semibold text-black">Landowner</span>
          </Link>
